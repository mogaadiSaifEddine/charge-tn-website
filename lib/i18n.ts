...
export const translations = {
  en: {
    ...
    flexibleEarningsDesc: "Set your own rates and availability. Earn TND200-800+ monthly on average.",
  ...
  fr: {
    ...
    flexibleEarningsDesc: "Fixez vos propres tarifs et disponibilité. Gagnez 200-800TND+ par mois en moyenne.",
  ...
  es: {
    ...
    flexibleEarningsDesc: "Establece tus propias tarifas y disponibilidad. Gana TND200-800+ mensualmente en promedio.",
  ...
  de: {
    ...
    flexibleEarningsDesc:
      "Setzen Sie Ihre eigenen Tarife und Verfügbarkeit. Verdienen Sie durchschnittlich TND200-800+ monatlich.",
